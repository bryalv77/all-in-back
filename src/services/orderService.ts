...
import DeliveryMethodRepository from '../database/repositories/deliveryMethodRepository';
...
export default class OrderService {
  ...
  async create(data) {
    ...
    try {
      ...
      data.deliver = await DeliveryMethodRepository.filterIdInTenant(data.deliver, { ...this.options, transaction });
