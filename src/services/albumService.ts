...
export default class AlbumService {
  ...
  async create(data) {
    ...
    try {
      ...
      const record = await AlbumRepository.create(data, {
        ...this.options,
        transaction,
      });
  ...
  async update(id, data) {
    ...
    try {
      ...
      const record = await AlbumRepository.update(
        id,
        data,
        {
          ...this.options,
  ...
  async destroyAll(ids) {
    ...
    try {
      for (const id of ids) {
        await AlbumRepository.destroy(id, {
          ...this.options,
          transaction,
        });
      }
  ...
  async findById(id) {
    return AlbumRepository.findById(id, this.options);
  }

  async findAllAutocomplete(search, limit) {
    return AlbumRepository.findAllAutocomplete(
      search,
      limit,
      this.options,
    );
  ...
  async findAndCountAll(args) {
    return AlbumRepository.findAndCountAll(
      args,
      this.options,
    );
  }
