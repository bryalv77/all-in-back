...
export default class TeacherService {
  ...
  async create(data) {
    ...
    try {
      ...
      const record = await TeacherRepository.create(data, {
        ...this.options,
        transaction,
      });
  ...
  async update(id, data) {
    ...
    try {
      ...
      const record = await TeacherRepository.update(
        id,
        data,
        {
          ...this.options,
  ...
  async findById(id) {
    return TeacherRepository.findById(id, this.options);
  }

  async findAllAutocomplete(search, limit) {
    return TeacherRepository.findAllAutocomplete(
      search,
      limit,
      this.options,
    );
  ...
  async findAndCountAll(args) {
    return TeacherRepository.findAndCountAll(
      args,
      this.options,
    );
  }
